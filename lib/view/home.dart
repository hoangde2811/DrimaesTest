...
import '../utils/write_readfile/writer_readfilethongbao.dart';
import 'view_dungchung/elavabutton_icon_dungchung.dart';
import 'view_dungchung/leading_dungchung.dart';
import 'view_dungchung/padding_dungchung.dart';
import 'view_dungchung/textspan_dungchung.dart';
import 'view_dungchung/view_load_dungchung.dart';
...
class Homescreen extends State<Home>  {
  ...
  // ChangeDataThongTin changeDataThongTin=Injection.getIt<ChangeDataThongTin>();
  ...
  void initState() {
    ...
    getPath();
        ...
        context.read<ChangeDataToggle>().addDataListWidgetToggle(_dataToggle);
        context.read<ChangeDataToggle>().addDataListSelectedToggle(_selectedToggle);
                          ...
                          if (value_data.connectionState ==ConnectionState.done) {
                            if (value_data.hasData) {
                              ...
                              if (call_first==false){
                                ...
                                context.read<ChangeDataThongTin>().addDataListWidgetThongTin(list_data_thongtin);
                                call_first=true;
                              }
